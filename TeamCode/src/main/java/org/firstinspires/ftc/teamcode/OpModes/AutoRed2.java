...
public class AutoRed2 extends LinearOpMode {
    ...
    public static Pose2d DEPOT_POS = new Pose2d(-32.5,0, Math.toRadians(269));
    public static Pose2d PARK_POS = new Pose2d(-30,0, Math.toRadians(269));
        ...
        while(opModeIsActive()){
            ...
            switch(mRobotState) {
                case PRE_LOAD_FREIGHT:
                    ...
                    points.add(new CurvePoint(FREIGHT_POS, 1d, 1d, 25));
                ...
                case CYCLE:
                    ...
                    points.add(new CurvePoint(new Pose2d(0, 0, Math.toRadians(270)), 1d, 1d, 15)); //2nd POINT FOR FREIGHT_CYCLE
                    /*switch(cycle){
                        case 0:
                        case 3:
                ...
                case CYCLE2:
                    ...
                    points.add(new CurvePoint(new Pose2d(7, -1, Math.toRadians(270)), 1d, 1d, 10)); //2nd POINT FOR FREIGHT_CYCLE
                    if(cycle <= numCycles) {
                        points.add(new CurvePoint(new Pose2d(DEPOT_POS.getX() - cycle * 0.75, DEPOT_POS.getY(), DEPOT_POS.getHeading()), 1d, 1d, 15));
                    }else{
                        points.add(new CurvePoint(PARK_POS, 1d, 1d, 15));
                    }

                    if(cycle >= 2){
                        points.add(new CurvePoint(new Pose2d(DEPOT_POS.getX() + 0.1 - cycle * 1.5, DEPOT_POS.getY() + cycle * 1.0, DEPOT_POS.getHeading() + Math.toRadians(30)), 1d, 1d, 5));
                    }
